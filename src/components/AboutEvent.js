...
function AboutEvent() {
  ...
  return (
    <section id='experience'>
      <h1
        className='font-bold about-heading'
        style={{ fontSize: '2rem', fontFamily: 'Blackpast' }}
      >
        About The Event
      </h1>
            ...
            <div className='stack'>
              ...
              <div className='about'>
                <p>
                  ...
                  user sees and interacts with. Here at Technotweet 2k23, we
                  will help you with the topics like React.js, APIs, Hooks, etc
                  along with a hands-on project. A well-designed and optimized
                  frontend is essential for creating a successful and effective
                  website. So, do attend and get ready to build amazing websites
            ...
            <div className='stack'>
              ...
              <div className='about'>
                <p>
                  ...
                  concepts throughout the sessions. So get ready for building
                  the backbone of powerful applications!
                </p>
              </div>
            </div>
          </div>
